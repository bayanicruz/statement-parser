#!/usr/bin/env python3
"""Transaction CSV → XLSX budget tracker with outstanding authorisations."""
import argparse
import re
import subprocess
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert transaction CSV to XLSX with outstanding authorisations.")
